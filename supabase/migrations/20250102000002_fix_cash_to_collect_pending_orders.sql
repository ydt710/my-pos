-- =============================================
-- MIGRATION: Fix Cash to Collect calculation for pending orders
-- =============================================
-- This migration fixes the get_dashboard_stats function to properly count
-- 'pending' orders in the "Cash to Collect" stat instead of 'processing' orders.
-- In our system, online orders are created as 'pending', not 'processing'.
-- =============================================
