-- =============================================
-- MIGRATION: Fix debt calculation in dashboard stats
-- =============================================
-- This migration fixes the debtCreatedToday calculation to only count
-- actual unpaid debt, not all sales transactions
-- =============================================

-- Update the get_dashboard_stats function to only count unpaid debt
