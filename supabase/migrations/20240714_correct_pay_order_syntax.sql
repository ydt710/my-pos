-- Corrects the syntax of the pay_order function and implements the logic for tracking debt paid at checkout.

-- Drop the previous, syntactically incorrect function if it exists
DROP FUNCTION IF EXISTS public.pay_order(uuid, numeric, numeric, numeric, text, jsonb, text, boolean);

-- Re-create the function with the correct syntax and logic
