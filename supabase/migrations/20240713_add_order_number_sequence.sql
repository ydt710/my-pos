-- Creates a sequence for order numbers and updates the pay_order function to use it.
...
-- Re-create the function to include order number generation.
...
BEGIN
    ...
    -- Step 6: Calculate cash kept for stats and adjust balance change if giving change.
